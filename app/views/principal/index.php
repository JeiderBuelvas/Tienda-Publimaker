<?php include 'app/views/layouts/header.php';?>
   ...
   <!-- <section class="slider_section">
         <div class="slider_bg_box">
            <img src="<?=BASE_URL?>/public/assets/principal/images/slider-bg.jpg" alt="" />
         </div>
                        ...
                        <div class="row">
                           <div class="col-md-7 col-lg-6">
                                 <div class="detail-box">
                                    ...
                                    <p>
                                       Explicabo esse amet tempora quibusdam laudantium, laborum eaque magnam fugiat hic? Esse dicta aliquid error repudiandae earum suscipit fugiat molestias, veniam, vel architecto veritatis
   ...
   <section class="product_section py-5">
      <div class="container">
            <div class="heading_container heading_center">
               <h2>Portafolio de <span>productos</span></h2>
            </div>

            <div class="row">
               <!--BUCLE DE CATEGORIAS Y SUBCATEGORIAS  -->
               <?php foreach ($categorias as $categoria): ?>
               <div class="col-sm-6 col-md-4 col-lg-4 mb-3">
                  <div class="row">
                     <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                        <div class="img-box">
                           <img src="https://placehold.co/400x600/orange/white" alt="" class="img-fluid" />
                        </div>
                     </div>
                     <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                        <div class="text-box">
                           <span class="d-block font-weight-bold">
                              <a class="text-dark" href="<?=BASE_URL?>/productos/categoria/<?=$categoria['id']?>">
                                 <?php echo htmlspecialchars($categoria['nombre']); ?>
                              </a>
                           </span>
                           <?php if (!empty($categoria['subcategorias'])): ?>
                              <?php foreach ($categoria['subcategorias'] as $subcategoria): ?>
                                 <a class="text-dark small d-block mb-1"
                                 href="<?=BASE_URL?>/productos/subcategoria/<?=$categoria['id']?>/<?=$subcategoria['id']?>">
